...
QJSP is a dedicated program set up within the Zahra Hasanaat Trust. Zahra Hasanaat is a Charitable Trust registered with the Indian Charity Commissioner (Regn. No. E 24221 M) and it is approved for 80G Tax Exempt Status, it is also approved by the Foreign Contribution (Regulation) Act (FCRA). QJSP, as an independent program within Zahra Hasanaat, aims to develop a specific endowment fund to sponsor higher education. Although QJSP is under the Zahra Hasanaat umbrella, it will maintain independent accounts.
